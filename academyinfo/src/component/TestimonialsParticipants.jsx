        ...
        <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-3 gap-10 mx-20 ">
          ...
          <div className="p-2 radius-yellow rounded-3xl max-w-sm flex flex-col justify-center items-center bg-gray">
            ...
            Excellent. I am thankful to Mr.
             Rajiv as he has given me so much insight into
              the Business. He is working as a Catalyst in the liv
              es of Small and Medium scale Entrepreneurs who are the backbone of
               the economy of our country. Thanks a lot to him. 
          ...
          <div className="p-2 radius-yellow rounded-3xl max-w-sm flex flex-col justify-center items-center bg-gray">
            ...
            I have had sleepless nights thinking, it will be great
             ...
             if I knew how to solve all my business-related problems
             . This program feels like a perfect destination to answer all my questions. Identifying department-wise goals and action points blew my mind.
