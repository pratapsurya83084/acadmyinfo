...
const Workshop = () => {
  return (
    <div className="flex flex-col justify-center pl-10 w-full lg:max-w-full lg:flex-row  lg:space-y-0 gap-5 lg:space-x-10   rounded-lg">
      {/*section -5 Left Side - Image */}

      <div className="flex justify-center items-center mt-10">
        <div className="w-full  justify-center">
          {/* image and name */}
          {/* <div className="bg-custom-brown lg:ml-4 rounded-full h-[300px] w-[300px]  lg:h-[350px] lg:w-[350px] mx-auto lg:mx-0 relative">
            <h1 className=" animate-move-x-reverse  relative right-14   lg:right-10 text-5xl lg:text-6xl  font-bold">
              Bishop
            </h1>
            <img
              className="h-[360px]  lg:h-80 rounded-lg ml-6  w-42 lg:w-full    "
              src="https://rajivtalreja.sgacademy.info/wp-content/uploads/2023/04/rajv.png"
              alt="Workshop Image"
            />
            <h1 className="animate-move-x-reverse text-4xl relative  bottom-20 right-4 lg:right-0 mb-2 ml-52 lg:ml-72 animate-slide  lg:text-6xl font-bold text-white">
              Adhikari
            </h1>
          </div> */}
          
<div className="bg-custom-brown   lg:ml-[90px]   rounded-full h-[250px] w-[250px] md:h-[300px] md:w-[300px]   mx-auto lg:mx-0 relative">
  <h1 className="animate-move-x-reverse relative right-0 sm:ml-5 text-4xl  sm:text-6xl sm:right-[200px]  md:text-7xl md:right-60 md:ml-10
  lg:right-28   lg:text-7xl lg:ml-2 font-bold">
    Bishop
  </h1>
  <img
...
<h1 className="animate-move-x-reverse font-bold relative  mt-32 left-40 bottom-0 md:bottom-14 md:mt-60 md:left-[290px] lg:left-[150px]  lg:mt-[270px] right-0  text-4xl sm:text-4xl md:text-5xl lg:text-5xl lg:font-bold text-white mb-4 mr-4 lg:text-right">
  Adhikari
          ...
          <div className="bg-custom-brown w-full lg:w-[500px] text-xl  md:mt-[85px]   p-6 lg:mt-[85px] mt-1  rounded-3xl ">
            <div>
              <div className=" w-full  text-center p-3">
                ...
                Trained over <span className="font-bold px-2"> 1, 90,000</span>
                Students & Business Enthusiast for{" "}
            ...
            <div className="bg-custom-gray m-4 p-4 py-4 rounded-3xl text-center">
              ...
              <p>
                ...
                & Business Enthusiast Rated My coaching style.
              </p>
            </div>
          </div>
          <div>
            <button className="lg:hidden mt-10 bg-blue-600 w-full justify-center p-5 font-bold lg:text-2xl rounded-2xl relative">
              Action Now with ₹99
      ...
      <div className="flex flex-col items-center max-w-full space-y-4  lg:max-w-lg mx-auto lg:mx-0 mt-4">
        ...
        <div className="bg-custom-brown w-full p-4 rounded-3xl text-xl">
  ...
  <div className="hidden mt-10 lg:p-5 lg:flex whitespace-nowrap  relative bg-blue-600 rounded-2xl">
