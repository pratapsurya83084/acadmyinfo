...
const Workshop = () => {
  return (
    <div className="workshop mt-7 px-5 flex flex-col pl-10 w-full lg:max-w-full lg:flex-row lg:gap-14 justify-center lg:space-y-0 rounded-lg">
    {/* Left Side - Image */}
    ...
    <div className="flex flex-col items-center w-full space-y-4 lg:max-w-lg mx-auto lg:mx-0 mt-4">
